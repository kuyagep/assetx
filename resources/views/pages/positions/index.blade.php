                    ...
                    <div class="row mb-3 ">
                        <div class="col-12">
                            <a href="javascript:void(0)" id="add-button" class="btn bg-dark mr-2 float-left" accesskey="a">
                                <i class="fa-regular fa-square-plus"></i>&nbsp;Add Position
                            </a>
    ...
    <script type="text/javascript">
        $(document).ready(function($) {
            ...
            $('body').on('click', '#viewButton', function() {
                ...
                var id = $(this).data('id');
                var route = "{{ route('positions.show', ':id') }}";
            ...
            $('body').on('click', '#editButton', function() {
                ...
                var id = $(this).data('id');
                var route = "{{ route('positions.edit', ':id') }}";
                route = route.replace(':id', id);
            ...
            $('body').on('click', '#deleteButton', function() {
                ...
                var id = $(this).data('id');
                var route = "{{ route('positions.destroy', ':id') }}";
                route = route.replace(':id', id);

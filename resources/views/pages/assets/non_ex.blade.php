        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row mb-3 ">
                        <div class="col-12">
                            <a href="{{ route('assets.create') }}" class="btn bg-dark mr-2 float-left" accesskey="a">
                                <i class="fa-solid fa-paper-plane mr-2"></i>&nbsp;Add New Asset
                            </a>
                            {{-- <a href="#" class="btn bg-dark mr-2 float-left" accesskey="a">
                                <i class="fa-solid fa-paper-plane mr-2"></i>&nbsp;Add Stocks
                            </a> --}}
                        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="javascript:void(0)" name="modal-form" id="modal-form" class="form-horizontal"
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label for="name">Qty <span
                                                                class="text-danger">*</span></label>
                                                        <input type="number" class="form-control"
                                                            id="balance_per_card_qty" name="balance_per_card_qty"
                                                            placeholder="Ex. 0">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label for="name">Value <span
                                                                class="text-danger">*</span></label>
                                                        <input type="number" class="form-control"
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label for="name">Qty <span
                                                                class="text-danger">*</span></label>
                                                        <input type="number" class="form-control"
                                                            id="onhand_per_count_qty" name="onhand_per_count_qty"
                                                            placeholder="Ex. 0">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-12">
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label for="name">Qty <span
                                                                class="text-danger">*</span></label>
                                                        <input type="number" class="form-control"
                                                            id="shortage_overage_qty" name="shortage_overage_qty"
                                                            placeholder="Ex. 0">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-12">
                                ...
                                <div class="modal-footer justify-end">
                                    ...
                                    <button type="submit" class="btn btn-dark btn-save px-5"

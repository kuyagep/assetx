                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                            website with regards to the information that they shared and/or collect in Project DAVAOSUR.
                        ...
                        <p>Project DAVAOSUR follows a standard procedure of using log files. These files log visitors when
                        ...
                        <p>Like any other website, Project DAVAOSUR uses "cookies". These cookies are used to store
                        ...
                        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
                            that are used in their respective advertisements and links that appear on Project DAVAOSUR,
                        ...
                        <p>Note that Project DAVAOSUR has no access to or control over these cookies that are used by
                            third-party advertisers.</p>

                        <h2>Third Party Privacy Policies</h2>

                        <p>Project DAVAOSUR's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                        ...
                        <p>Project DAVAOSUR does not knowingly collect any Personal Identifiable Information from children

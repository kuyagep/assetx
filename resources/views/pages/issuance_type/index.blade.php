...
{{-- Page Title --}}
@section('page-title', 'Manage Issuance Type')
{{-- Content Header --}}
@section('content-header', 'Manage Issuance Type')
{{-- Main content --}}
                ...
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"> List of Issuance Type</h3>
                            <div class="card-tools">
                                <a href="javascript:void(0)" id="add-button" class="btn btn-primary mr-2">
                                    <i class="fa fa-plus mr-1"></i>&nbsp;Add Issuance Type
                                </a>
                            </div>
                            <!-- /.card-tools -->
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="name">Issuance Type Name <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="name" name="name"
                                                placeholder="Ex. Inventory Custodian Slip">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        $(document).ready(function($) {
            ...
            $('#modal-form').submit(function(e) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: "{{ route('super_admin.issuance-type.store') }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
            ...
            $('body').on('click', '#viewButton', function() {
                ...
                var id = $(this).data('id');
                var route = "{{ route('super_admin.issuance-type.show', ':id') }}";
            ...
            $('body').on('click', '#editButton', function() {
                ...
                var id = $(this).data('id');
                var route = "{{ route('super_admin.issuance-type.edit', ':id') }}";
                route = route.replace(':id', id);
            ...
            $('body').on('click', '#deleteButton', function() {
                ...
                var id = $(this).data('id');
                var route = "{{ route('super_admin.issuance-type.destroy', ':id') }}";
                route = route.replace(':id', id);

...
{{-- Page Title --}}
@section('title_prefix', 'Manage Issuance Type')
{{-- Content Header --}}
                    ...
                    <div class="row mb-3 ">
                        <div class="col-12">
                            <a href="javascript:void(0)" id="add-button" class="btn bg-dark mr-2 float-left" accesskey="a">
                                <i class="fa-solid fa-paper-plane mr-2"></i>Add Issuance Type
                            </a>
    ...
    <script type="text/javascript">
        $(document).ready(function($) {
            ...
            $('body').on('click', '#viewButton', function() {
                ...
                var id = $(this).data('id');
                var route = "{{ route('issuance-type.show', ':id') }}";
            ...
            $('body').on('click', '#editButton', function() {
                ...
                var id = $(this).data('id');
                var route = "{{ route('issuance-type.edit', ':id') }}";
                route = route.replace(':id', id);
            ...
            $('body').on('click', '#deleteButton', function() {
                ...
                var id = $(this).data('id');
                var route = "{{ route('issuance-type.destroy', ':id') }}";
                route = route.replace(':id', id);

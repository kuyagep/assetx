                ...
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title mr-2"> List of Classifications </h3> <small><a
                                    href="https://www.coa.gov.ph/issuances/manuals/#110-2139-government-accounting-manual-gam-for-national-government-agencies"
                                    target="_black">Learn
                                    more</a></small>
    ...
    <script type="text/javascript">
        $(document).ready(function($) {
            ...
            var table = $("#dataTableajax").DataTable({
                ...
                select: true,
                autoWidth: false,
                ajax: "{{ url('admin/classifications') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        class: 'text-center'
            ...
            $('#modal-form').submit(function(e) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: "{{ route('admin.classifications.store') }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
            ...
            $('body').on('click', '#viewButton', function() {
                ...
                var id = $(this).data('id');
                var route = "{{ route('admin.classifications.show', ':id') }}";
            ...
            $('body').on('click', '#editButton', function() {
                ...
                var id = $(this).data('id');
                var route = "{{ route('admin.classifications.edit', ':id') }}";
                route = route.replace(':id', id);
            ...
            $('body').on('click', '#deleteButton', function() {
                ...
                var id = $(this).data('id');
                var route = "{{ route('admin.classifications.destroy', ':id') }}";
                route = route.replace(':id', id);

        ...
        $(document).ready(function($) {
            ...
            $('#modal-form').submit(function(e) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: "{{ route('admin.asset-status.store') }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
            ...
            $('body').on('click', '#viewButton', function() {
                ...
                var id = $(this).data('id');
                var route = "{{ route('admin.asset-status.show', ':id') }}";
            ...
            $('body').on('click', '#editButton', function() {
                ...
                var id = $(this).data('id');
                var route = "{{ route('admin.asset-status.edit', ':id') }}";
                route = route.replace(':id', id);
            ...
            $('body').on('click', '#deleteButton', function() {
                ...
                var id = $(this).data('id');
                var route = "{{ route('admin.asset-status.destroy', ':id') }}";
                route = route.replace(':id', id);

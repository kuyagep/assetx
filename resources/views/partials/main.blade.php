    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-secondary elevation-1">
            ...
            <a href="index3.html" class="brand-link">
                <img src="{{ asset('assets/dist/img/AdminLTELogo.png') }}" alt="App Logo"
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ !empty(Auth::user()->avatar) ? url('assets/dist/img/avatar/' . Auth::user()->avatar) : url('assets/dist/img/avatar/avatar5.png') }}"
                                        ...
                                        <div class="card-body p-0">
                                            <ul class="users-list clearfix">
                                                <li>
                                                    ...
                                                    <a class="users-list-name" href="javascript:void(0)">Alexander
                                                        Pierce</a>
